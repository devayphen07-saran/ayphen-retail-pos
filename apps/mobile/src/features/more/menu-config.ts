 ...
 * permission matrix yet) — every item is shown, and every item routes to the
 * same "Coming soon" placeholder until its real feature ships.
 */
...
export const MORE_SECTIONS: readonly MoreSectionConfig[] = [
...

  {
    ...
    description: 'Profile, hours, and subscription',
    iconName: 'Store',
    iconColor: 'neutral',
    items: [
      {
